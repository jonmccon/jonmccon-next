...
export default function FavouriteProjects() {
  ...
  return (
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-stone-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-stone-500 my-20 md:my-0 md:text-white dark:text-stone-600 text-center">
            Favourite Projects
          </h1>
          <Link
            href="/projects"
